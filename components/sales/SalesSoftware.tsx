...
const softwareOptions = [
  {
    ...
    description: 'Custom-built quoting platform your reps use on-site. Professional proposals, Good/Better/Best pricing, and full pipeline tracking — branded to your company.',
  ...
  },
  {
    ...
    description: 'A professional visual sales presentation built for your trade. Walk homeowners through your process, present packages, and collect e-signatures before you leave.',
            ...
            >
              ...
              <div style={{ padding: '2rem 2rem 1.5rem' }}>
                <div style={{
                  ...
                  background: sw.accent, marginBottom: '1rem',
                }} />
                <h3 style={{
                  fontFamily: 'DM Sans, sans-serif',
        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              <span style={{
                fontSize: '0.65rem', fontWeight: 700, color: '#94D96B',
